...
input sequence. Each input is included in every sub-hash. The
...
#!/usr/bin/env -S Rscript --vanilla
ironseed::ironseed()
#> ** Ironseed : Seed TbRwSxJoCkZ-GvJXG5F26ZA-VjrNiqjSVBW-J4kxXxffNz6
runif(10)
#>  [1] 0.1618574 0.3789795 0.9722971 0.6267010 0.1385357 0.1155440 0.1712731
#>  [8] 0.3602058 0.6060578 0.3351454
...
fe
#> Ironseed: TbRwSxJoCkZ-GvJXG5F26ZA-VjrNiqjSVBW-J4kxXxffNz6
```
...
#!/usr/bin/env -S Rscript --vanilla
fe <- ironseed::ironseed()
#> ** Ironseed : Seed McsSakFbfeZ-Y2k6SnCabCG-tnSVNMik3ah-MM9gmVfjy7Q
runif(10)
#>  [1] 0.85425272 0.32382031 0.97069095 0.46213512 0.37050778 0.66005836
#>  [7] 0.39201272 0.51697894 0.56388478 0.09079601
fe
#> Ironseed: McsSakFbfeZ-Y2k6SnCabCG-tnSVNMik3ah-MM9gmVfjy7Q
```
