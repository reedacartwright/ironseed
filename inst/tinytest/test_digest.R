...
# hund_obj: serialize(100L, connection = NULL, ascii = FALSE, xdr = FALSE)
hund_obj <- as.raw(c(
  0x42, 0x0a, 0x03, 0x00, 0x00, 0x00, 0x02, 0x05, 0x04,
  0x00, 0x00, 0x05, 0x03, 0x00, 0x05, 0x00, 0x00, 0x00, 0x55, 0x54,
  0x46, 0x2d, 0x38, 0x0d, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
  0x64, 0x00, 0x00, 0x00
))

expect_equal(digest(hund_obj, serialize = FALSE), -122472043)
expect_equal(digest(100L), -122472043)
