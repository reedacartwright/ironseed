...
# hund_obj: serialize(100L, connection = NULL, version = 2L, ascii = FALSE, xdr = FALSE)
hund_obj <- as.raw(c(
  0x42, 0x0a, 0x02, 0x00, 0x00, 0x00, 0x02, 0x05, 0x04,
  0x00, 0x00, 0x03, 0x02, 0x00, 0x0d, 0x00, 0x00, 0x00, 0x01, 0x00,
  0x00, 0x00, 0x64, 0x00, 0x00, 0x00
))

expect_equal(digest(hund_obj, serialize = FALSE), -975609684)
expect_equal(digest(100L), -975609684)
